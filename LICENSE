...
This is a source-available license. It is not an open-source license and does not grant rights beyond those expressly stated below.
...
You may not, without prior written permission from I/US Music:
...
4. GitHub Platform Notice

If this repository is hosted publicly on GitHub, GitHub users may have certain limited rights to view and fork the repository through GitHub’s own platform functionality, as required by GitHub’s Terms of Service.

No permission is granted beyond those minimum platform rights unless explicit written permission is given by I/US Music.
